...
Запустите файл run_prediction_of_model.ipyn. Внём показано как использовать модель для инференса на примере одного из тестовых изображений.

### В локальной среде jupyter notebook:
Установите git в свою операционную систему. Клонируйте проект в корневую директорию jupyter notebook.
Запустите файл run_prediction_of_model.ipyn.

### В Google Colab:
Просто запустите run_prediction_of_model.ipyn.
