...
Установите git в свою операционную систему. Клонируйте проект.
Далее можете открыть и запустить файл run_prediction_of_model.ipyn. Внём показано как использовать модель для инференса на примере одного из тестовых изображений.
