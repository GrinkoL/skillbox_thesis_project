...
В проекте используется технология transfer learning. В качестве базовой модели выбрана модель VGG16. Данная модель (совместимая с Keras) с весами полученными при обучении на датасете VGGFace2 доступна в  [проекте](https://github.com/rcmalli/keras-vggface)
